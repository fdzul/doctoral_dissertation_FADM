...
<img src = "figs/OR_test_negative_design_2012_2019.jpg"  width="300px" height="300px>
...
DiagrammeR::grViz("digraph {
  ...
  hotspots [label = 'Identificación de los Hotspots', style = filled, color = orange]
  
  # flowchart for hotspots
 
  val [label = 'Validación de los Hotspots',  style = filled, color = orange]
  # 
...
- Carga de la Enfermedad (Wen 2006, Almeida et al 2007, Wen et al 2010, Liu et al 2013, Ling et al 2014, Ratanawong et al 2016, Acharya et al 2016, Fuentes-Vallejo et al 2017, Vicente et al 2017, Hernandez-Gaytán et al, 2017, Hafeez et al 2017, Sun et al 2017, Bisanzio et al 2018 
)

- Abundancia diferencial (Ka-Chon et al 2018)

- Riesgo Diferencial (Bisanzio et al 2018)

- Intervenciones (Com.Pers Felipe Dzul)

- Infección Diferencial en el Vector (Com.Pers Felipe Dzul)
]
...
.pull-left[
.blue[Literatura]
20% de las unidades espaciales y sus áreas identificadas como hotspots contribuyen entre el 20% y el 60% de los casos reportados en la ciudad y en este espacio viven entre el 20% y el 60% de la población (Wen et al 2006, Wen et al 2010, Fuentes-Vallejo et al 2017, Vicente et al 2017, Hafeez et al 2017, Qu et al 2018, Bisanzio et al 2018, Lai et al 2018) 

]
.pull-rigth[
.blue[Resultado del Presente Estudio]
